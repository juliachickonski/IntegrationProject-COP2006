...
// Long: holds 8 bytes with range of  -9,223,372,036,854,775,808 to 
//9,223,372,036,854,775,807 (Whole numbers only)
...
// inheritance is the  process where one class acquires the methods and fields 
//of another parent class
// follows a hierarchy
// useful because you can reuse methods and fields of the parent class. 

// Polymorphism describes how subclasses can perform their own actions while still 
//relating to the same parent class

public class Main {
  /**
   * asks user their name and what kind of tasks the program should perform. 
   */
  public static void main(String[] args) {
    // Variable describes the area in the program where data values are stored
    // scope describes that variables can only be accessed within the certain
    // area created
    ...
    System.out.println("Hello " + firstNameUser + "!. "
        + " Did you know, there is a difference of " + nameDifference
        + " lexicographically between your first and last name.");

    // equals method to determine if user has one of the most common last names
    if (name1Common.equalsIgnoreCase(lastNameUser) == true
        || name2Common.equalsIgnoreCase(lastNameUser) == true
        || name3Common.equalsIgnoreCase(lastNameUser) == true) {
      System.out.println(
          "*Fun Fact: You have one of the most common last names in the US!*");
    }
    ...
    do {
      ...
      if (userChoice == 1) {
        ...
        do {
          System.out.println(
              "Here you can enter two numbers to compare.\nEnter Variable 1 to compare: ");
          ...
          if (variable1Double > variable2Double) {
            System.out.println(variable1Double + " is greater than "
                + variable2Double + ": " + trueBoolean);
          } else {
            System.out.println(variable1Double + " is greater than "
                + variable2Double + ": " + falseBoolean);
          }
          System.out.println(
      ...
      if (userChoice == 2) {
        ...
        System.out.println("\nHere I am going to demonstrate widening casting");
        // Widening casting converts from a smaller data type to a larger
        ...
        System.out
            .println("\nHere I am going to demonstrate narrowing casting");
        // narrowing casting converts from a larger data type to a smaller
        ...
        System.out.println(
            "To see a further explination press 1, any other number to continue on");
        int example2Choice = scan.nextInt();
        if (example2Choice == 1) {
          System.out.println(
              "Widening casting brings a smaller data type to a larger one. "
                  + "\nNarrowing Casting converts a larger data type to a smaller one"
                  + "Press 1 to exit the program.");
          int finalChoice = scan.nextInt();
          if (finalChoice == 1) {
            continue; // continue is used here to break the loop and give the
            // user the goodbye message and end the program
          }
        }
      }
      if (userChoice == 3) {
        ...
        do {
          ...
          // Addition
          if (userMathChoice == 1) {
            double sum = getSum(scan); // the getSum is the method call and scan
            // is the argument
          ...
          if (userMathChoice == 2) {
            System.out
                .println("Enter the numbers you would like to subtract: ");
            try {
          ...
          // multiplication
            ...
            for (int numsMultiplying = 0; numsMultiplying < numsToMultiply;) {
              ...
              break; 
              // The break is used here to stop program from infinitelylooping
            }
            ...
            final double ExponentAnswer = (double) (Math.pow(baseNumber,
                exponentNumber));
            // final is used here to create a constant for
            // EXPONENTANSWER
            // https://www.geeksforgeeks.org/final-keyword-java/
            System.out.println("The answer is: " + ExponentAnswer);
          }
          System.out.println("\nWhat should I do next? \n*press 1 to"
              + " return to math menu \n*press any other number to "
              + "continue");
      ...
      if (userChoice == 5) {
        ...
        System.out
            .println("The sum of all the values in your array is: " + sum);

        ArrayList<Integer> exampleArray2 = new ArrayList<Integer>();
        // creates an array from the arraySize
        ...
        System.out
            .println("The smallest value in this list is: " + smallestNumber);
      }

      System.out.println(
          "Press 1 to return to menu, any other number to exit the program");
      programRepeat = scan.nextInt();
    } while (programRepeat == 1);
    // == works by comparing what is stored in programRepeat to 1
  ...
  /**
 * Gets the sum of however many numbers the user wants to add together.

 * @param scan numbers should all be integers.
 * @return sum of users numbers added together.
 */
  // addition get
  
  public static double getSum(Scanner scan) {
    // public is the header and (Scanner scan) is the parameter
